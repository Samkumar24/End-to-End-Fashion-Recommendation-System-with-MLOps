...
from src.recommendation_system.components._05_model_building import model_building_check



class model_training_pipline:
    ...
    def main(self):
        ...
        model_feature = model_building_check(model_feature)
